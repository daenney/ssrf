...
func TestOptions(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			Name:    "default",
			Options: nil,
			Result:  &Guardian{networks: []string{"tcp4", "tcp6"}, ports: []uint16{80, 443}, deniedv4Prefixes: IPv4SpecialPurpose, deniedv6Prefixes: IPv6SpecialPurpose},
		},
		{
			Name:    "with port 53",
			Options: []Option{WithPorts(53)},
			Result:  &Guardian{networks: []string{"tcp4", "tcp6"}, ports: []uint16{53}, deniedv4Prefixes: IPv4SpecialPurpose, deniedv6Prefixes: IPv6SpecialPurpose},
		},
		{
		...
		},
		{
			...
			Result:  &Guardian{networks: []string{"tcp4", "tcp6"}, ports: nil, deniedv4Prefixes: IPv4SpecialPurpose, deniedv6Prefixes: IPv6SpecialPurpose},
		},
		{
			Name:    "with any port",
		...
		},
		{
			...
			Result:  &Guardian{networks: []string{"udp6"}, ports: []uint16{80, 443}, deniedv4Prefixes: IPv4SpecialPurpose, deniedv6Prefixes: IPv6SpecialPurpose},
		},
		{
		...
		},
		{
			...
			Result:  &Guardian{networks: nil, ports: []uint16{80, 443}, deniedv4Prefixes: IPv4SpecialPurpose, deniedv6Prefixes: IPv6SpecialPurpose},
		},
		{
		...
		},
		{
			...
			Result:  &Guardian{networks: []string{"tcp4", "tcp6"}, ports: []uint16{80, 443}, allowedv4Prefixes: []netip.Prefix{netip.MustParsePrefix("8.8.8.0/24")}, deniedv4Prefixes: IPv4SpecialPurpose, deniedv6Prefixes: IPv6SpecialPurpose},
		},
		{
		...
		},
		{
			...
			Result:  &Guardian{networks: []string{"tcp4", "tcp6"}, ports: []uint16{80, 443}, allowedv6Prefixes: []netip.Prefix{netip.MustParsePrefix("2002::/8")}, deniedv4Prefixes: IPv4SpecialPurpose, deniedv6Prefixes: IPv6SpecialPurpose},
		},
		{
		...
		},
		{
			...
			Result:  &Guardian{networks: []string{"tcp4", "tcp6"}, ports: []uint16{80, 443}, deniedv4Prefixes: append([]netip.Prefix{netip.MustParsePrefix("8.8.8.0/24")}, IPv4SpecialPurpose...), deniedv6Prefixes: IPv6SpecialPurpose},
		},
		{
		...
		},
		{
			...
			Result:  &Guardian{networks: []string{"tcp4", "tcp6"}, ports: []uint16{80, 443}, deniedv4Prefixes: IPv4SpecialPurpose, deniedv6Prefixes: append([]netip.Prefix{netip.MustParsePrefix("2002::/8")}, IPv6SpecialPurpose...)},
		},
		{
